...
#----------------------------------------#
#     Run Model and Follow-Up SHAP       #
#----------------------------------------#
if __name__ == "__main__":
    # Directories for feature and outcome (y) data
    ...
    #Load and Preprocess using function from above
    x_array_imputed, y_data, num_timesteps = load_and_prepare_data(phase_csv, outcome_csv)

    #Model build using settings from above
